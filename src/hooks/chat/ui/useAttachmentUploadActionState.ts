...
import type { useImageAttachmentState } from "./useImageAttachmentState";
import type { useTextAttachmentState } from "./useTextAttachmentState";
import {
    getLanguageFromFilename,
    isTextFile,
    MAX_TOTAL_IMAGE_BYTES,
    toErrorMessage,
} from "../implementation/attachmentPolicies";
...
export const useAttachmentUploadActionState = ({
    uploadImage,
    imageState,
    textState,
    fileInputRef,
