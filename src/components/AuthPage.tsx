...
import { Mail, Lock, GraduationCap, Chrome, Loader2, ArrowRight, Eye, EyeOff } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signin') {
        ...
        // Server-side signup as per instructions
        const response = await fetch(`https://${projectId}.supabase.co/functions/v1/make-server-5abdc916/signup`, {
          method: 'POST',
          headers: {
      ...
      <div className="bg-white w-full max-w-5xl h-[600px] rounded-[3rem] shadow-2xl flex overflow-hidden border border-slate-100">
        ...
        <div className="hidden md:flex flex-1 bg-slate-50 relative items-center justify-center overflow-hidden">
           ...
           <div className="relative z-10 p-8 backdrop-blur-md bg-white/30 rounded-2xl border border-white/50 shadow-lg max-w-xs">
              ...
              <h3 className="font-bold text-xl text-slate-800 mb-2">精通力学</h3>
              <p className="text-sm text-slate-600">加入数万名通过 AI 辅助掌握理论力学的学生行列。</p>
           </div>
        </div>
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-2 mb-10 justify-center">
               <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white animate-[spin_10s_linear_infinite]"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1-1-1.72v-.51a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" /><circle cx="12" cy="12" r="3" /></svg>
               </div>
               <span className="font-bold text-2xl text-slate-900 tracking-tight text-[32px]" style={{ fontFamily: "Courier New, monospace" }}>MechHub</span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 ml-1">邮箱地址</label>
              ...
              <div>
                <div className="flex justify-between items-center mb-2 ml-1">
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider">密码</label>
                  {mode === 'signin' && (
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-2 text-slate-500">或通过以下方式继续</span>
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-center">
               ...
               <button className="p-3 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors" title="校园账号登录 (模拟)">
