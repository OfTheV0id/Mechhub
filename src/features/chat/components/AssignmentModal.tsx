    ...
    const assignments: Assignment[] = [
        {
            ...
            deadline: "2023-10-25",
            status: "pending",
            description: "完成第3章习题 3-1 至 3-5，并提交分析过程。",
        },
        {
            id: "2",
            title: "运动学：点的合成运动",
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            <div className="flex items-center gap-2">
                                                <div
                                                    className={`p-2 rounded-lg ${selectedId === assignment.id ? "bg-blue-100 text-[#0B57D0]" : "bg-white text-slate-500"}`}
                                                >
                                                    <FileText size={18} />
                                                </div>
                                        ...
                                        <p className="text-sm text-slate-500 ml-10 mb-3">
